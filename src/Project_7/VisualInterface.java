...
public class VisualInterface {
    ...
    public static VBox getVBox() {
        ...
        shadow.setOffsetX(5.0); shadow.setOffsetY(5.0);
        ...
        Button btE = new Button("Enter"); Button btF = new Button("Find"); 
        Button btD = new Button("Delete"); Button btL = new Button("List All"); 
    ...
    public static VBox enterPane() {
        ...
        nameLabel.setFont(new Font("Rockwell", 15));
